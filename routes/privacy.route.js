...
router.put('/admin/privacy/:id', [authJwt.isAdmin, objectId.validId], termsController.updateTerm);

// DELETE a term and condition by ID
router.delete('/admin/privacy/:id', [authJwt.isAdmin, objectId.validId], termsController.deleteTerm);
