...
module.exports = (app) => {
    ...
    app.post("/api/v1/admin/createProduct",[authJwt.isAdmin],productController.createProduct);
    app.patch("/api/v1/admin/product/:id",[authJwt.isAdmin, objectId.validId],productController.update);
